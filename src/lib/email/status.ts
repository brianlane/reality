    ...
    case 'PAYMENT_PENDING':
      ...
      additionalInfo = `
        ...
        <div style="text-align: center; margin: 32px 0;">
          <a href="${process.env.NEXT_PUBLIC_APP_URL}/apply/payment" style="display: inline-block; background-color: #c8915f; color: white; text-decoration: none; padding: 16px 32px; border-radius: 6px; font-size: 16px; font-weight: 600; box-shadow: 0 2px 4px rgba(200, 145, 95, 0.3);">
            Complete Payment
          </a>
        </div>
      `;
