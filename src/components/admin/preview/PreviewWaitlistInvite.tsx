    ...
    <div className="space-y-4">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-800">
          <strong>Preview Mode:</strong> This is Stage 3 - Waitlist Invite. When
          the admin invites someone off the waitlist, they receive an email with
          a unique link that brings them to this page.
        </p>
      </div>
      ...
      <div className="bg-white border rounded-lg p-6 space-y-4">
        <div className="text-center space-y-3">
          ...
          <p className="text-navy-soft">
            Congratulations! You&rsquo;ve been selected to continue your
            application. Click the button below to get started.
          </p>
        </div>
        ...
        <div className="flex justify-center pt-4">
          <Button
            onClick={() =>
              alert(
                "Preview mode - navigation disabled. In real flow, this would take the applicant to Stage 4 (Demographics).",
              )
            }
          >
